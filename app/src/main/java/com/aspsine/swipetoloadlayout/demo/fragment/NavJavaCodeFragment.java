...
public class NavJavaCodeFragment extends BaseNavigationFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private void changeFooter(int i) {
        ...
        switch (i) {
            case 0:
                view = mInflater.inflate(R.layout.layout_hcare_footer, swipeToLoadLayout, false);
                break;
            case 2:
    ...
    private void changeHeader(int i) {
        ...
        switch (i) {
            case 0:
                view = mInflater.inflate(R.layout.layout_hcare_header, swipeToLoadLayout, false);
                break;
            case 1:
